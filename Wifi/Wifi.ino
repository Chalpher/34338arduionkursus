...
void setup() {
  ...
  Serial.println();
  wifiMulti.addAP("OnePlus 5T", "SatansKlimatosser123");  // add Wi-Fi networks you want to connect to
...
void handleRoot() {                         // When URI / is requested, send a web page with a button to toggle the LED
  server.send(200, "text/html", "<html><title>Internet of Things - Demonstration</title><meta charset=\"utf-8\" \/> \ 
      ...
      <p>Vil du vide mere: Kig på hjemmesiden for uddannelsen : <a href=\"www.dtu.dk/cyber\">Cyberteknologi</a></p> \
      </body></html>");
}
